...
ggplot(data, aes(reorder(Neighborhood, SalePrice), SalePrice)) +
  ...
  labs(y="Precio de venta", 
       x="Vecindario", 
       title="Precio de según vecindario")
...
ggplot(data, aes(ExterQual, SalePrice, colour=YearBuilt)) +
  ...
  coord_flip() +
  scale_colour_gradientn(colours=rainbow(6)) +
  labs(x="Calidad de los exteriores de la vivienda", 
       y="Precio de venta",
       color="Año de construcción",
       title="Precio de la vivienda vs Año de construcción y Calidad del exterior")
```
...
ggplot(data, aes(YearBuilt, SalePrice, colour=GarageQual)) +
  ...
  labs(x="Año de construcción / calidad de los materiales", 
       y="Precio de venta",
       color="calidad del garage",
       title="Precio de venta vs Calidad del garaje y de los materiales y año de construcción")
```
...
ggplot(data = data, aes(x=GarageYrBlt, y=SalePrice)) + 
  ...
  labs(y="Precio de la vivienda", 
       ...
       title="Valores perdidos pra el año de contrucción vs Precio de venta")
```
...
ggplot(data = bind_shadow(data), aes(x = SalePrice, color = GarageYrBlt_NA)) +
   ...
   theme_light() +
   labs(y="Densidad", 
        x="Año de construcción del garaje)")
```
